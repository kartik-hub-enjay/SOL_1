          ...
          <div className="mt-6 pt-5 border-t border-paper/10">
            ...
            <div className="grid grid-cols-2 gap-2">
              <button
                ...
                className="p-2.5 rounded-xl bg-[#050702]/80 border border-paper/10 hover:border-[#BEF202]/50 text-left transition-all cursor-pointer"
              >
              ...
              <button
                ...
                className="p-2.5 rounded-xl bg-[#050702]/80 border border-paper/10 hover:border-violet-mist/50 text-left transition-all cursor-pointer"
              >
                <div className="text-xs font-bold text-paper flex items-center justify-between">
